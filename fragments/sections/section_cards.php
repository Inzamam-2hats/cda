...
<section class="section section--cards <?php echo ( $top_spacing ) ? 'section--large' : ''; ?> section--decorated">
	<?php if ( $gradient ) : ?>
					...
					<div class="row">
						<?php foreach ( $cards as $index => $card ) : ?>
							...
							<div class="col-sm-12 col-md-6 col-lg-3 fadeup animate" data-group="1">
								<a class="card-item" href="<?php echo esc_url( $link_url ); ?>"<?php echo $link_target ? ' target="' . esc_attr( $link_target ) . '"' : ''; ?>>
									...
									<div class="card-item__content">
										...
										<span class="card-item__link"><?php echo esc_html( $link_text ); ?></span>
